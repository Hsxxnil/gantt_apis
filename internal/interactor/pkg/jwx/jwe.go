...
func (j *JWE) Create() (*JWE, error) {
	...
	encrypted, err := jwe.Encrypt(payload, jwe.WithKey(jwa.RSA_OAEP_256, publicKey),
		jwe.WithContentEncryption(jwa.A256CBC_HS512), jwe.WithCompress(jwa.Deflate),
